          ...
          <div className="space-y-6">
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <div className="relative flex items-center">
                                ...
                                <Button variant="ghost" size="sm" className="absolute right-1" onClick={() => setPublicKey(`pk_live_${randomstring.generate(16)}`)}>
            ...
            <div className="space-y-2">
              ...
              <div className="relative flex items-center">
                ...
                <Button variant="ghost" size="sm" className="absolute right-1" onClick={() => setSecretKey(`sk_live_${randomstring.generate(16)}`)}>
                  <RefreshCw className="h-4 w-4 mr-2" />
                  Generate
                </Button>
              </div>
