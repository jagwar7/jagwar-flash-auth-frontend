...
import { CreateOrUpdate, GetCredentials } from '@/APIs/CredentialsAPI';
import { Storage } from '@/Storage/Storage';
import { useAlert } from '@/contexts/alert-state-context';
iimport randomstring from 'randomstring';
...
export default function UpdateCredentialsPage() {
  ...
  const [isMongodbUriVisible, setIsMongodbUriVisible] = useState(false);
    ...
    <div className="flex min-h-[calc(100vh-10rem)] items-center justify-center px-4 py-12">
      <Card className="w-full max-w-2xl shadow-2xl">
        ...
        <CardContent className="space-y-8">
          <div className="space-y-6">
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <div className="relative flex items-center">
                                ...
                                <Button variant="ghost" size="sm" className="absolute right-1" onClick={() => setPublicKey(`FA${randomstring.generate(16)}`)}>
            ...
            <div className="space-y-2">
              ...
              <div className="relative flex items-center">
                ...
                <Button variant="ghost" size="sm" className="absolute right-1" onClick={() => setSecretKey(`FA${randomstring.generate(16)}`)}>
                  <RefreshCw className="h-4 w-4 mr-2" />
                  Generate
                </Button>
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative flex items-center">
                ...
                <Input 
                  id="mongodb-uri" 
                  type={isMongodbUriVisible ? 'text' : 'password'}
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative flex items-center">
                        ...
                        <Input 
                          ...
                          type={isGoogleClientSecretVisible ? 'text' : 'password'}
                          placeholder="GOCSPX-..." 
                          className="pl-10"
          ...
          <Button type="button" className="w-full" onClick={()=>UpdateCredentials()}>
            Save Credentials
          </Button>
        </CardContent>
      </Card>
